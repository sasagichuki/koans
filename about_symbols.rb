...
class AboutSymbols < Neo::Koan
  ...
  # todo THINK ABOUT IT: Why do we convert the list of symbols to strings and then compare against the string value rather than against symbols?
  ...
  #todo so constants dont become symbols ??
